...
const Header = () => {
    ...
    return (
        <nav className="z-20 transition ease-out duration-200 flex w-full sticky justify-center items-center justify-space-between text-dyblack py-3 bg-transparent backdrop-blur-md">
