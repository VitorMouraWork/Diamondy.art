...
const WikiHeader = () => {
  return (
<div className="flex justify-center fixed z-20 w-full top-10">
  <nav className="z-20 ease-out duration-200 drop-shadow-lg flex w-max sticky text-dyblack py-3 w-[80rem] max-w-[80rem] dark:bg-slate-900 bg-white items-center justify-between rounded-full px-5">
    ...
    <div className='flex p-1 px-2 space-x-2 border-2 border-gray-300 dark:border-slate-800 rounded-full ml-80'>
